/**
 * Boolean operators can be combined just like having multiple mathematical
 * operators in a math equation.
 * Like math equations, they can be combined using parentheses, where the
 * parentheses are completed first. Otherwise,
 * boolean operators are read left to right.
 *
 * Write this boolean logic without using any if statements - that is, you
 * should only use &&, ||, !, ==. All of these
...
public class AdvancedBooleanLogic {
     ...
     * @param b1 first boolean to be compared.
     * @param b2 second boolean to be compared.
     * @return true if either b1 or b2 is true, but false if they are both true or
     *         both false.
     */
     ...
     * @param b1 first boolean to be compared.
     * @param b2 second boolean to be compared.
     * @return true if neither b1 nor b2 are true. Return false if either b1 or b2
     *         is true.
     */
