...
public class StoreService {
    ...
    public Store getStoreById(long id){
        return storeRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("Store not found with id: " + id));
    }
    /**
    ...
    public Store updateStore(long id, Store replacement){
        Store existingStore = storeRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("Store not found with id: " + id));

        existingStore.setId(replacement.getId());
