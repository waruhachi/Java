...
public class Lab {
     ...
     * this problem uses doubles
     * rather than ints.
     *
     * Doubles represent numbers that may contain decimals. Whether you use an int
     * or double in your projects
     * depends on the use case. (For instance, you count the number of puppies at
     * your pet store with int / whole
