public class Application {
    /**
     * This class contains a main method that allows you to manually test the Arrays
     * lab functionality.
     ...
     *
     * The Lab methods should demonstrate some basic array manipulation
     * functionality.
     */
    public static void main(String[] args) {
        ...
        System.out
                .println("The length of the array {1, 2, 3, 4} is 4, and the lab produces this value as the length: ");
