 ...
 *
 * Or, we could have an array of our own custom Objects, such as our own Bird
 * class for a birdwatching
 * application. This would allow us to keep track of many birds and their own
 * behavior.
 *
 * For the following problems, all of the syntax we need is in this
 * documentation:
...
public class Lab {
     ...
     * @return nothing. Because of pass-by-reference, any change to the array will
     *         be reflected across our java program.
     */
