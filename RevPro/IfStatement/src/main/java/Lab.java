...
public class Lab {
    /**
     * An if statement uses a conditional statement (within parentheses) to
     * determine if the code
     * within {curly braces} should run.
     * If statements can be coupled with an else{} statement or else if(){}
     * statement.
     *
     ...
     * 
     * All variables needed to solve the problem are provided by the method
     * parameters - boolean bool, int x, int y.
     * This means that you can use the variables bool, x, and y freely, within the
     * if statement, to solve the problem.
     *
