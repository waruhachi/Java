public class Application {
    /**
     * This class contains a main method that allows you to manually test the While
     ...
     *
     * The Lab.whileExample lab will get the sum of all numbers from 1 to some
     * number >1. All code required to
