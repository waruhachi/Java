public class Application {
     ...
     * BooleanOperators lab functionality.
     ...
     *
     * The Lab methods should return the results of some boolean logic. The
     * resulting values will be printed here.
     */
    public static void main(String[] args) {
        ...
        System.out.println(
                "Here's what Lab.returnAnd returns when provided the values 'true', 'true' (should be 'true')");
        boolean result5 = booleanslab.returnAnd(true, true);
        System.out.println(result5);

        System.out.println("Consider the expression 'true AND false IS false'.");
        System.out.println(
                "Here's what Lab.returnAnd returns when provided the values 'true', 'false' (should be 'false')");
        ...
        System.out.println(
                "Here's what Lab.returnAnd returns when provided the values 'true', 'false' (should be 'true')");
        boolean result8 = booleanslab.returnOr(true, false);
        System.out.println(result8);

        System.out.println("Consider the expression 'false OR false IS false'.");
        System.out.println(
                "Here's what Lab.returnAnd returns when provided the values 'false', 'false' (should be 'false')");
