...
public class Application {
    /**
     * This class contains a main method that allows you to manually test the Hello
     * World lab functionality.
     ...
     *
     * The Lab.sayHello method should produce a value, "Hello, World!", which this
     * class should be able to print
